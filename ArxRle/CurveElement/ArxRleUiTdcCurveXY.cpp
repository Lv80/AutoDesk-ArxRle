...
void ArxRleUiTdcCurveXY::OnBnClickedCurveXyBnImport()
{
	...
	if (dlg.DoModal() == IDOK)
	{
		...
		if(m_curveElement.m_nJDNum == 3)
		{
			m_x1 = m_curveElement.m_vecJDElement[0].m_x;
			m_y1 = m_curveElement.m_vecJDElement[0].m_y;
			m_QD = m_curveElement.m_vecJDElement[0].m_JD;
			m_x2 = m_curveElement.m_vecJDElement[1].m_x;
			m_y2 = m_curveElement.m_vecJDElement[1].m_y;
			m_x3 = m_curveElement.m_vecJDElement[2].m_x;
			m_y3 = m_curveElement.m_vecJDElement[2].m_y;
			m_ZD = m_curveElement.m_vecJDElement[2].m_JD;
			m_R = m_curveElement.m_vecJDElement[1].m_R;
			m_ls = m_curveElement.m_vecJDElement[1].m_ls;
		}
...
void ArxRleUiTdcCurveXY::OnBnClickedCurveXyBnCalc() 
{
	...
	if(!m_openPathName.IsEmpty())
	{
		...
		for (int row = 0; row < vecParam.size(); row++)
		{
			...
			m_curveElement.ml_to_xy(vecParam[row].ml,x1,y1,fwj1,qxj1);
			m_curveElement.ml_to_xy(vecParam[row].ml+0.01,x2,y2,fwj2,qxj2);
	...
	else
	{
		...
		for (int row = 0; row < cnt; row++)
		{
			...
			CPt3d pt(x,y);
			pt = CPt3d::GetLineEnd(pt,m_mOffset,qxj+PI/2.0);
			...
			strGrid5 = FormatAngle(qxj*180/PI);
	...
	m_L = m_curveElement.m_vecJDElement[1].m_L;
	m_A = m_curveElement.m_vecJDElement[1].m_A;
	m_T = m_curveElement.m_vecJDElement[1].m_T;
	m_E = m_curveElement.m_vecJDElement[1].m_E;
	m_W = m_curveElement.m_vecJDElement[1].m_pj;
	m_ZH = m_curveElement.m_vecJDElement[1].m_ZH;
	m_HY = m_curveElement.m_vecJDElement[1].m_HY;
	m_QZ = m_curveElement.m_vecJDElement[1].m_QZ;
	m_YH = m_curveElement.m_vecJDElement[1].m_YH;
	m_HZ = m_curveElement.m_vecJDElement[1].m_HZ;
