...
extern void measureArea();
extern void measureLength();
extern void measureAllArea();
extern void measureAllLength();

//通用绘图
extern void drawCondition();
extern void drawHatch();
extern void drawNumber();
extern void drawBroken();
extern void drawDimLand();

//标准图块
extern void blockTK();
extern void blockBTL();
extern void blockZBZ();
...
ArxRleApp::registerCommands()
{
	...
	//测量工具
	cmdStack->addCommand(m_appName, _T("ArxRleMeasureCrdTrm"),         _T("MeasureCrdTrm"),         ACRX_CMD_MODAL, &measureCrdTrm);
	cmdStack->addCommand(m_appName, _T("ArxRleMeasureCurve"),          _T("MeasureCurve"),          ACRX_CMD_MODAL, &measureCurve);
	cmdStack->addCommand(m_appName, _T("ArxRleMeasurePtInData"),       _T("MeasurePtInData"),       ACRX_CMD_MODAL, &measurePtInData);
	cmdStack->addCommand(m_appName, _T("ArxRleMeasurePtOutData"),      _T("MeasurePtOutData"),      ACRX_CMD_MODAL, &measurePtOutData);
	cmdStack->addCommand(m_appName, _T("ArxRleMeasureArea"),           _T("MeasureArea"),           ACRX_CMD_MODAL, &measureArea);
	cmdStack->addCommand(m_appName, _T("ArxRleMeasureLength"),         _T("MeasureLenght"),         ACRX_CMD_MODAL, &measureLength);
	cmdStack->addCommand(m_appName, _T("ArxRleMeasureAllArea"),        _T("MeasureAllArea"),        ACRX_CMD_MODAL, &measureAllArea);
	cmdStack->addCommand(m_appName, _T("ArxRleMeasureAllLength"),      _T("MeasureAllLenght"),      ACRX_CMD_MODAL, &measureAllLength);

	//通用绘图
	cmdStack->addCommand(m_appName, _T("ArxRleDrawHatch"),            _T("DrawHatch"),              ACRX_CMD_MODAL, &drawHatch);
	cmdStack->addCommand(m_appName, _T("ArxRleDrawNumber"),           _T("DrawNumber"),             ACRX_CMD_MODAL, &drawNumber);
	cmdStack->addCommand(m_appName, _T("ArxRleDrawCondition"),        _T("DrawCondition"),          ACRX_CMD_MODAL, &drawCondition);
	cmdStack->addCommand(m_appName, _T("ArxRleDrawDimLand"),          _T("DrawDimLand"),            ACRX_CMD_MODAL, &drawDimLand);

	//标准图块
	cmdStack->addCommand(m_appName, _T("ArxRleBlockTK"),               _T("BlockTK"),               ACRX_CMD_MODAL, &blockTK);
	cmdStack->addCommand(m_appName, _T("ArxRleBlockBTL"),              _T("BlockBTL"),              ACRX_CMD_MODAL, &blockBTL);
	cmdStack->addCommand(m_appName, _T("ArxRleBlockZBZ"),              _T("BlockZBZ"),              ACRX_CMD_MODAL, &blockZBZ);
