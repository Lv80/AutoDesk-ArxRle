...
class ArxRleSdUnsortedStrList : public ArxRleSdStrList {

public:
        // constructors/destructors
                ArxRleSdUnsortedStrList()        {};
    virtual        ~ArxRleSdUnsortedStrList()    {};
...
class ArxRleSdSortedStrList : public ArxRleSdStrList {

public:
        // constructors/destructors
                ArxRleSdSortedStrList(BOOL caseSensitive = FALSE);
    virtual        ~ArxRleSdSortedStrList()    {};
