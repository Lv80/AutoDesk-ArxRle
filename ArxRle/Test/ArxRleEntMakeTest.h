...
/****************************************************************************
**
**  CLASS ArxRleEntMakeDbox:
**
**  **jma
**
*************************************/

class ArxRleEntMakeDbox : public CAcUiDialog {

public:
                ArxRleEntMakeDbox(CWnd* pParent);

    //{{AFX_DATA(ArxRleEntMakeDbox)
    enum { IDD = ARXRLE_DLG_ENTMAKE };
    //}}AFX_DATA

    // ClassWizard generated virtual function overrides
    //{{AFX_VIRTUAL(ArxRleEntMakeDbox)
    protected:
