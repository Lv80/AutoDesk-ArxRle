...
#include "Test/ArxRleXformTest.h"
#include "Test/ArxRleEntMakeTest.h"
#include "Test/ArxRleTblMakeTest.h"
...
ArxRleCmdTests::testXform()
{
    ArxRleXformTest dbox(acedGetAcadDwgView());
    dbox.DoModal();
}
...
ArxRleCmdTests::testEntMake()
{
    ArxRleEntMakeDbox dbox(acedGetAcadDwgView());
    dbox.DoModal();
}
