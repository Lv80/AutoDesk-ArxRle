...
/****************************************************************************
**
**  ArxRleEntMakeDbox::ArxRleEntMakeDbox    (constructor)
**
**  **jma
**
*************************************/

ArxRleEntMakeDbox::ArxRleEntMakeDbox(CWnd* pParent)
:   CAcUiDialog(ArxRleEntMakeDbox::IDD, pParent, ArxRleApp::getApp()->dllInstance())
{
    //{{AFX_DATA_INIT(ArxRleEntMakeDbox)
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::DoDataExchange
**
**  **jma
**
*************************************/
...
void
ArxRleEntMakeDbox::DoDataExchange(CDataExchange* pDX)
{
    CAcUiDialog::DoDataExchange(pDX);
    //{{AFX_DATA_MAP(ArxRleEntMakeDbox)
...
BOOL
ArxRleEntMakeDbox::OnCmdMsg(UINT nID, int nCode, void* pExtra, AFX_CMDHANDLERINFO* pHandlerInfo)
{
    m_buttonId = nID;
...
/////////////////////////////////////////////////////////////////////////////
// ArxRleEntMakeDbox message map

BEGIN_MESSAGE_MAP(ArxRleEntMakeDbox, CAcUiDialog)
    //{{AFX_MSG_MAP(ArxRleEntMakeDbox)
...
/////////////////////////////////////////////////////////////////////////////
// ArxRleEntMakeDbox message handlers

/****************************************************************************
**
**  ArxRleEntMakeDbox::OnButtonClicked
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::getPointArray
...
Acad::ErrorStatus
ArxRleEntMakeDbox::getPointArray(AcGePoint3dArray& vertices, int& ptCount)
{
    int i = 0;
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makePolyline
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::make2dPolyline
**
**  NOTES:
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::make3dPolyline
**
**  NOTES:
...
void
ArxRleEntMakeDbox::makeVface(AcDbPolyFaceMesh* pface, const AcGePoint3d& pt1, const AcGePoint3d& pt2,
...
void
ArxRleEntMakeDbox::recordVface(AcDbPolyFaceMesh* pface, int vertex1, int vertex2, int vertex3, int vertex4)
{
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makePolyFaceMesh
**
**  NOTES:
...
void
ArxRleEntMakeDbox::nextNvertex(int nSize, const AcGePoint3d& pt1, const AcGePoint3d& pt2, AcDbPolygonMesh* mesh)
{
...
AcGePoint3d
ArxRleEntMakeDbox::nextMvertex(int mSize, int loop, const AcGePoint3d& pt1, const AcGePoint3d& pt2)
{
    double xInc, yInc, zInc;
    AcGePoint3d newPt;
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::addPolygonMeshVertex
**
**  **jma
**
*************************************/
...
void
ArxRleEntMakeDbox::addPolygonMeshVertex(AcDbPolygonMesh* mesh, const AcGePoint3d& pt)
{
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makePolygonMesh
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::make2LineAngularDim
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::make3PointAngularDim
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeAlignedDim
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeDiametricDim
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeOrdinateDim
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeRadialDim
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeRotatedDim
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeAttributes
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleEntMakeDbox::makeAttributes(const AcDbObjectId& blockRecordId, AcDbBlockReference* blkRef)
{
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::getBlockSpecFromUser
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleEntMakeDbox::getBlockSpecFromUser(AcDbObjectId& blockId, AcGePoint3d& insertPt,
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeBlockReference
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeMInsertBlock
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeViewport
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::makeAttributeDefinition
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::getArcCircleCenterRadius
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleEntMakeDbox::getArcCircleCenterRadius(AcGePoint3d& centerPt, double& radius)
{
    AcDbCircle* circle;
    AcDbArc* arc;
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::get3PointArc
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleEntMakeDbox::get3PointArc(AcGePoint3d& centerPt, AcGePoint3d& pt1, AcGePoint3d& pt2)
{
    AcDbArc* arc;
    Acad::ErrorStatus ret = Acad::eInvalidInput;
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::getLineOrTwoPoints
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleEntMakeDbox::getLineOrTwoPoints(AcGePoint3d& pt1, AcGePoint3d& pt2)
{
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::getAngularDimLines
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleEntMakeDbox::getAngularDimLines(AcGePoint3d& pt1, AcGePoint3d& pt2,
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::getDimRotationAngle
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleEntMakeDbox::getDimRotationAngle(double& ang)
{
...
/****************************************************************************
**
**  ArxRleEntMakeDbox::getDimHorizRotation
