...
cmdTestTblMake()
{
    ArxRleTblMakeDbox dbox(acedGetAcadDwgView());
    dbox.DoModal();
}

/****************************************************************************
**
**    ArxRleTblMakeDbox::ArxRleTblMakeDbox    (constructor)
**
**    **jma
**
*************************************/

ArxRleTblMakeDbox::ArxRleTblMakeDbox(CWnd* pParent)
:    CDialog(_T("ARXRLE_DLG_TBLMAKE"), pParent)
{
    //{{AFX_DATA_INIT(ArxRleTblMakeDbox)
...
BOOL
ArxRleTblMakeDbox::OnCmdMsg(UINT nID, int nCode, void* pExtra, AFX_CMDHANDLERINFO* pHandlerInfo)
{
    m_buttonId = nID;
...
/****************************************************************************
**
**    ArxRleTblMakeDbox::DoDataExchange
**
**    **jma
**
*************************************/
...
void
ArxRleTblMakeDbox::DoDataExchange(CDataExchange* pDX)
{
    CDialog::DoDataExchange(pDX);
    //{{AFX_DATA_MAP(ArxRleTblMakeDbox)
        // NOTE: the ClassWizard will add DDX and DDV calls here
    //}}AFX_DATA_MAP
}

/////////////////////////////////////////////////////////////////////////////
// ArxRleTblMakeDbox message map

BEGIN_MESSAGE_MAP(ArxRleTblMakeDbox, CDialog)
    //{{AFX_MSG_MAP(ArxRleTblMakeDbox)
...
/////////////////////////////////////////////////////////////////////////////
// ArxRleTblMakeDbox message handlers

/****************************************************************************
**
**    ArxRleTblMakeDbox::OnButtonClicked
**
**    **jma
**
*************************************/
...
/****************************************************************************
**
**    ArxRleTblMakeDbox::makeNamedBlock
**
**    **jma
**
*************************************/
...
/****************************************************************************
**
**    ArxRleTblMakeDbox::makeAnonymousBlock
**
**    **jma
**
*************************************/
...
/****************************************************************************
**
**    ArxRleTblMakeDbox::makeDimstyle
**
**    **jma
**
*************************************/
...
/****************************************************************************
**
**    ArxRleTblMakeDbox::makeLinetype
**
**    **jma
**
*************************************/
...
/****************************************************************************
**
**    ArxRleTblMakeDbox::makeTextstyle
**
**    **jma
**
*************************************/
...
/****************************************************************************
**
**    ArxRleTblMakeDbox::makeViewport
**
**    **jma
**
*************************************/
...
/****************************************************************************
**
**    ArxRleTblMakeDbox::addToSymbolTableAndClose
**
**    **jma
**
*************************************/
...
BOOL
ArxRleTblMakeDbox::addToSymbolTableAndClose(AcDbSymbolTableRecord* symRec)
{
    BOOL stat = FALSE;
...
/****************************************************************************
**
**    ArxRleTblMakeDbox::setSymbolName
**
**    **jma
**
*************************************/
...
BOOL
ArxRleTblMakeDbox::setSymbolName(AcDbSymbolTableRecord* newRec, LPCTSTR newName)
{
    Acad::ErrorStatus es;
    CString str;
