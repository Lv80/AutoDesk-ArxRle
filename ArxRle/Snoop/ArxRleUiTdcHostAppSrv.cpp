...
ArxRleUiTdcHostAppSrv::displayCurrent()
{
	...
	addToDataList(_T("Registry Product LCID"), ArxRleUtils::intToStr(appSrv->getRegistryProductLCID(), str));
	addToDataList(_T("Code Page Id"), ArxRleUtils::intToStr(appSrv->getSystemCodePage(), str));
